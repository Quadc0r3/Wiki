...
<div class="nav_box flex-center">
    <div class="recent_articles_container">
        <div class="recent_articles_title">Recently edited Pages</div>
...
//            echo "<tr><td colspan='3' align='center' class='pagination_container'>";
//            for ($page = 1; $page <= $totalPages; $page++) {
//                echo "<a href='?page=$page' class='pagination_button'>" . ($page) . "</a>";
//            }
//            echo "</td></tr>";
//            ?>
<!--        </table>-->
        <table id="articleTable" title="Recent Articles">
            <tr>
                <td>Page</td>
                <td>Creator</td>
                <td>Last Edited</td>
